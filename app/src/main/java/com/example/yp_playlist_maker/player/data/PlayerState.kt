...
sealed interface PlayerState {
    ...
    data class StatePlaying(val currentPosition: String, val percentPosition: Float) : PlayerState
    data object Pause : PlayerState
    data object Prepared : PlayerState
    data class Complete(val startPosition: String) : PlayerState
    data class Resume(val track: Track, val currentPosition: String, val percentPosition: Int) :
        PlayerState
}